...
@Component({
    selector: 'save-usuarios',
    templateUrl: '../views/save-usuarios.html',
    providers: [UserService]
})

export class SaveUsuariosComponent implements OnInit{
    ...
    ngOnInit(){
        console.log('users guaradr cargado');
        this.getUsuarios();
